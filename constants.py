...
degree_names = {'M':["I", "ii", "iii", "IV", "V", "vi", "vii"], 'm':["i", "ii", "III", 'iv', 'v', 'VI', 'VII']}
...
class Pit():
    def __init__(self, midi = None, scale = None, degree = None, sign = 0):
        ...
        self.degree = degree
        self.sign = sign
        if self.midi == None and self.scale != None and self.degree != None:
...
next = {0:[0,1,2,3,4,5,6],1:[3,4,0],2:[3],3:[0,4],4:[0,3,5],5:[1,4], 6:[0]}
...
seventh_probs = {0:0, 1:0.1, 2:0.1, 3:0.0, 4:0.4, 5:0, 6:0}
ninth_probs = {0:0.1, 1:0.1, 2:0.1, 3:0.1, 4:0, 5:0.0, 6:0.1}

inversion_probs = {0:{0:0.7, 1:0.25, 2:0.05}, 1:{0:0.5, 1:0.5}, 2:{0:0.7, 1:0.3}, 3:{0:0.5, 1:0.3, 2:0.2}, 4:{0:0.5, 1:0.3, 2:0.2}, 5:{0:0.4, 1:0.6}, 6:{1:1.0}}